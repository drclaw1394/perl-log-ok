...
These modules are NOT dependencies of C<Log::OK>.
...
like to syncrhonise the levels in C<Log::OK> and your logger, it will need to
...
L<git://github.com/drclaw1394/perl-log-ok.git>
